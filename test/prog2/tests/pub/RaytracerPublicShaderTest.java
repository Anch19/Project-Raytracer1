...
public class RaytracerPublicShaderTest
  extends RayTracerTestBase
  implements PublicTest, ShaderExercise {
  ...
  public void testCheckerBoardSimple() {
    printCurrentMethodName();
    checkColorCheckerboardSimple(
      new SingleColor(Color.BLACK),
      new SingleColor(Color.WHITE),
      Color.BLACK,
      Color.WHITE
    );
  }
  ...
  public void testCheckerBoardConstructor_Null() {
    printCurrentMethodName();
    assertTrue(
      createCheckerBoardWithException(
        IllegalArgumentException.class,
        null,
        new SingleColor(Color.RED),
        1.0f
      )
    );
    assertTrue(
